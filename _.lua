...
function __StarciaConnect:Load(CanvasSizeA,CanvasSizeB)
    __StarciaGUI = {
    ...
    __StarciaGUI[2].Size = UDim2.new(0.300000012, 0, 0.300000012, 0)
    ...
    __StarciaGUI["__Execute"].TextSize = 16.000
    ...
    __StarciaGUI["__Inject"].Text = "[ Inject ]"
    __StarciaGUI["__Inject"].TextColor3 = Color3.fromRGB(255, 255, 255)
    __StarciaGUI["__Inject"].TextSize = 16.000
    ...
    __StarciaGUI[6].CanvasSize = UDim2.new(CanvasSizeA, 0, CanvasSizeB, 0)
    ...
    __StarciaGUI["__Inject"].MouseButton1Click:Connect(function()
        __StarciaGUI["__Inject"].Text = "[ Auth... ]"
        wait(0.5)
        __StarciaGUI["__Inject"].Text = "[ Connected ]"
